...
import { DataTableToolbarCaregiver } from "./dataTableToolbarCaregiver";
...
export function DataTableCaregiver<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div className="relative mb-4 space-y-4 px-4">
      <div className="overflow-auto px-1 py-1">
        <DataTableToolbarCaregiver table={table} />
      </div>
      ...
      <div className="relative overflow-auto px-4 py-2">
