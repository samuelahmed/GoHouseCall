export function PrivacyPolicy() {
  return (
    <div>
      <h1 className="py-1 text-xl font-bold md:py-2 md:text-3xl">
        House Call Privacy Policy
      </h1>
      ...
      <h3 className="md:text-1xl py-1 text-lg md:py-2">2.1 Log Data</h3>
      <p className="py-1 md:py-2">
      ...
      <h3 className="md:text-1xl py-1 text-lg md:py-2">2.2. Cookies</h3>
      <p className="py-1 md:py-2">
      ...
      <h2 className="py-1 text-xl md:py-2 md:text-2xl">3. Service Providers</h2>
      <p className="py-1 md:py-2">
        We may employ third-party companies and individuals due to the following
        reasons:
        {/* create a bulleted list */}
      </p>
      <ul className="list-disc py-1 pl-4 md:py-2">
        <li className="py-1">To facilitate our Service;</li>
        <li className="py-1">To provide the Service on our behalf;</li>
        <li className="py-1">To perform Service-related services; </li>
        <li className="py-1">
      ...
      <h2 className="py-1 text-xl md:py-2 md:text-2xl">7. Contact Us</h2>
      <p className="py-1 md:py-2">
